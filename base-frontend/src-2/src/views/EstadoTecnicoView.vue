<template>
  <div>
   <div style=" background-color: #003366; color: white; text-align: right;">
    ...
    margin-right: 630px;">Listado de estados tecnicos:</h6>
    <br />
    ...
    <tr v-for="(item, index) in estados_tecnicos" :key="item.id">
      ...
      <td v-if="hasGroup('Admin')">
        <button  class="btn btn-warning btn-small">
            ...
            <button style="margin-left: 10px" @click.prevent="confirmDelete(item.codigo_estado_tecnico)" class="btn btn-danger btn-small">
