...
from .views import vagones_productos,productos_vagones_productos_view_set
...
router.register('vagones-productos',vagon_cargado_descargado_view_set,basename='vagones_productos')
router.register('productos-vagones-cargados-descargados',productos_vagones_productos_view_set,basename='productos_vagones_productos')
