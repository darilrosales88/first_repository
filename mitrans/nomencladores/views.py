...
class nom_pais_view_set(viewsets.ModelViewSet):
    ...
    search_fields=['nacionalidad','nombre_pais']
...
class nom_provincia_view_set(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAdminNomenladoresPermission | IsVisualizadorNomencladoresPermission]
    filter_backends=[filters.SearchFilter,filters.OrderingFilter,DjangoFilterBackend]
    search_fields=['codigo','nombre_provincia','pais__nombre_pais']
...
class nom_contenedor_view_set(viewsets.ModelViewSet):
    ...
    filter_backends=[filters.SearchFilter,filters.OrderingFilter,DjangoFilterBackend]
    search_fields=["id_contenedor","tipo_contenedor", "longitud", "codigo_iso"]
...
class nom_atraque_view_set(viewsets.ModelViewSet):
    ...
    search_fields=['nombre_atraque','puerto__nombre_puerto','terminal__nombre_terminal']
...
class nom_entidades_view_set(viewsets.ModelViewSet):
    ...
    search_fields=["nombre","abreviatura","tipo_entidad","provincia__nombre_provincia"]
...
class nom_embarcacion_view_set(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAdminNomenladoresPermission | IsVisualizadorNomencladoresPermission]
    filter_backends=[filters.SearchFilter,filters.OrderingFilter,DjangoFilterBackend]
    search_fields=["nombre_embarcacion","nacionalidad__nacionalidad","tipo_embarcacion"]
...
class nom_producto_view_set(viewsets.ModelViewSet):
    ...
    search_fields = ['nombre_producto', 'codigo_producto', 'tipo_producto']  # Campos
