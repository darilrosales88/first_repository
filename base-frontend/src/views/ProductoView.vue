      ...
      <div class="card border">
        ...
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <router-link v-if="hasGroup('Admin')" to="CrearProducto">
  ...
  methods: {
    ...
    openProductoDetailsModal(Producto) {
      ...
      const gruposAsignados =
        Producto.groups && Producto.groups.length > 0
          ? Producto.groups
              .map((groupId) => {
      ...
      const permisosAsignados =
        ...
        Producto.Producto_permissions.length > 0
          ? Producto.Producto_permissions.map((permisoId) => {
