      ...
      <div class="card border">
        <div class="card-header bg-light border-bottom">
          <h6 class="mb-0 text-dark fw-semibold">
            Tipo de equipos ferroviarios
          </h6>
        </div>
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <router-link v-if="hasGroup('Admin')" to="AdicionarTipoEquipo">
          ...
          <div class="table table-responsive">
            <table class="table table-sm table-bordered table-hover">
              <thead class="table-light">
                <tr>
                  <th scope="col" style="width: 100px">Tipo de equipo</th>
                  <th scope="col" style="width: 100px">Tipo de carga</th>
                  <th scope="col" style="width: 100px">Tipo de combustible</th>
                  <th scope="col" style="width: 100px">Longitud</th>
                  <th scope="col" style="width: 100px">Peso neto sin carga</th>
                  <th scope="col" style="width: 100px">Peso máximo con carga</th>
                  <th scope="col" style="width: 100px">Capacidad cúbica máxima</th>
                  <th scope="col" style="width: 140px">Descripción</th>
                ...
                <tr v-for="item in tipos_equipos" :key="item.id">
                  ...
                  <td>
                    <div class="d-flex" >
                      ...
                      <button
                        @click="editTipoFerroviario(item)"
