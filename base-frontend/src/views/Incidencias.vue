      ...
      <div class="card border">
        ...
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <router-link v-if="hasGroup('Admin')" to="/CrearIncidencia">
              <button class="btn btn-sm btn-primary">
                <i class="bi bi-plus-circle me-1"></i>Adicionar incidencia
              </button>
            </router-link>
            <form @submit.prevent="search_incidencia" class="search-container">
      ...
      Swal.fire({
        ...
        html: `
            <div style="text-align: left;">
                ...
                <p><strong>Incidencia:</strong> ${Incidencia.nombre_incidencia}</p>
