...
CREATE TABLE IF NOT EXISTS "gemar_gemar_programacion_maniobras" (
	"id"	integer NOT NULL,
	"buque"	varchar(255) NOT NULL,
	"formato_eta"	smallint unsigned NOT NULL CHECK("formato_eta" >= 0),
	"fecha_eta"	date,
	"hora_eta"	time,
	"hora_eta_am_pm"	smallint unsigned CHECK("hora_eta_am_pm" >= 0),
	"formato_ets"	smallint unsigned NOT NULL CHECK("formato_ets" >= 0),
	"fecha_ets"	date,
	"hora_ets"	time,
	"hora_ets_am_pm"	smallint unsigned CHECK("hora_ets_am_pm" >= 0),
	"cantidad_remolcadores"	smallint unsigned NOT NULL CHECK("cantidad_remolcadores" >= 0),
	"observaciones"	text,
	"atraque_id"	bigint NOT NULL,
	"puerto_id"	bigint NOT NULL,
	"puerto_procedencia_id"	bigint,
	"terminal_id"	bigint NOT NULL,
	"tipo_maniobra_id"	bigint NOT NULL,
	PRIMARY KEY("id" AUTOINCREMENT),
	FOREIGN KEY("tipo_maniobra_id") REFERENCES "nomencladores_nom_tipo_maniobra_portuaria"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("puerto_procedencia_id") REFERENCES "nomencladores_nom_puerto"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("puerto_id") REFERENCES "nomencladores_nom_puerto"("id") DEFERRABLE INITIALLY DEFERRED,
	FOREIGN KEY("atraque_id") REFERENCES "nomencladores_nom_atraque"("id") DEFERRABLE INITIALLY DEFERRED,
...
INSERT INTO "django_admin_log" ("id","object_id","object_repr","action_flag","change_message","content_type_id","user_id","action_time") VALUES (1,'9','AdminGEMAR',2,'[{"changed": {"fields": ["Permissions"]}}]',3,1,'2025-08-01 08:52:45.047868');
INSERT INTO "django_admin_log" ("id","object_id","object_repr","action_flag","change_message","content_type_id","user_id","action_time") VALUES (2,'1','Admin',2,'[{"changed": {"fields": ["Permissions"]}}]',3,1,'2025-08-01 08:53:11.721577');
INSERT INTO "django_admin_log" ("id","object_id","object_repr","action_flag","change_message","content_type_id","user_id","action_time") VALUES (3,'9','AdminGEMAR',2,'[{"changed": {"fields": ["Permissions"]}}]',3,1,'2025-08-01 08:53:46.996937');
INSERT INTO "gemar_gemar_parte_hecho_extraordinario" ("id","fecha_operacion","fecha_actual","estado_parte","aprobado_por_id","creado_por_id","entidad_id","provincia_id") VALUES (14,'2025-07-30 00:00:00','2025-07-30 11:17:24.860485','Creado',NULL,1,1,1);
...
CREATE INDEX IF NOT EXISTS "gemar_gemar_programacion_maniobras_atraque_id_fa08daa5" ON "gemar_gemar_programacion_maniobras" (
	"atraque_id"
);
CREATE INDEX IF NOT EXISTS "gemar_gemar_programacion_maniobras_puerto_id_0db56517" ON "gemar_gemar_programacion_maniobras" (
	"puerto_id"
);
CREATE INDEX IF NOT EXISTS "gemar_gemar_programacion_maniobras_puerto_procedencia_id_28b0911f" ON "gemar_gemar_programacion_maniobras" (
	"puerto_procedencia_id"
);
CREATE INDEX IF NOT EXISTS "gemar_gemar_programacion_maniobras_terminal_id_0f1a15aa" ON "gemar_gemar_programacion_maniobras" (
	"terminal_id"
);
CREATE INDEX IF NOT EXISTS "gemar_gemar_programacion_maniobras_tipo_maniobra_id_18e766eb" ON "gemar_gemar_programacion_maniobras" (
	"tipo_maniobra_id"
);
