...
export default {
  ...
  methods: {
    ...
    agregarVagon() {
      ...
      if (this.formData.equipo_vagon.length == 0 || this.formData.equipo_vagon.length > this.formData.cantidad_vagones ) {
        Swal.fire({
          title: "Error",
          text: "Vagones sobrantes, elimine un vagón",
          icon: "error",
        });
        return;
      }
