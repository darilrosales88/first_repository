...
const routes = [
  ...
  /*PARA ACCEDER A LOS COMPONENTES DE UFC */
  {
    path: '/vagones_cargados_descargados',
    name: 'vagones_cargados_descargados',
    component: () => import('../views/ufc/vagones_cargados_descargados/vagones_cargados_descargados.vue'),
    meta:{
      requireLogin :true,
    }
  },
  {
    path: '/adicionar_vagon_cargado_descargado',
    name: 'adicionar_vagon_cargado_descargado',
    component: () => import('../views/ufc/vagones_cargados_descargados/add_vagones_cargados_descargados.vue'),
    meta:{
      requireLogin :true,
    }
  },
  ...
  {
    path: '/productos_vagones_cargados_descargados',
    name: 'productos_vagones_cargados_descargados',
    component: () => import('../views/ufc/vagones_cargados_descargados_productos/vagones_cargados_descargados_productos.vue'),
    meta:{
      requireLogin :true,
    }
  },
  {
    path: '/adicionar_productos_vagones_cargados_descargados',
    name: 'adicionar_productos_vagones_cargados_descargados',
    component: () => import('../views/ufc/vagones_cargados_descargados_productos/add.vue'),
    meta:{
      requireLogin :true,
    }
  },
