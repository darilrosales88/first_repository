    ...
    <div class="card border">  
      <div class="card-header bg-light border-bottom">
        <h5 class="mb-0 text-dark fw-semibold">
          <i class="bi bi-file-earmark-plus me-2"></i> Nuevo registro cargado/descargado
        </h5>
      </div>
    ...
    async submitForm() {
      try {
        ...
        const payload = {
          ...
          causa_incumplimiento: this.formData.causas_incumplimiento,
        ...
        const response = await axios.post("/ufc/ccd-vagones-cd/", payload);
        this.resetForm();
        this.$router.push({ name: "ccdxproducto" });
