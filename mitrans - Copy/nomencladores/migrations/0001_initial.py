# Generated by Django 5.1.2 on 2025-02-24 18:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_cargo', models.CharField(max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^[A-Z][\\w ]{1,19}$', 'Este campo comienza con letra mayúscula seguida de hasta 19 caracteres alfabéticos y espacios.')], verbose_name='Cargo')),
            ],
            options={
                'verbose_name': 'Cargos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100, unique=True, validators=[django.core.validators.RegexValidator('^[A-Z][\\w\\d\\W]{2,99}', 'Este campo comienza con mayúscula, acepta letras, números y caracteres especiales. Tamaño mínimo 2 caracteres y tamaño máximo 100 caracteres.')], verbose_name='Nombre')),
                ...
                ('tipo_entidad', models.CharField(choices=[('I', 'Importador'), ('E', 'Exportador'), ('T', 'Transportista'), ('AC', 'Acceso comercial'), ('CN', 'Compañía naviera'), ('M', 'Mitrans'), ('O', 'Otros')], default='DC', help_text='Escoja una opción.', max_length=30, verbose_name='Tipo de entidad')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='osde_oace_organismo',
            field=models.ForeignKey(blank=True, help_text='Escoja una opción.', null=True, on_delete=django.db.models.deletion.CASCADE, to='nomencladores.nom_osde_oace_organismo', verbose_name=' OSDE/OACE u organismo '),
        ),
        migrations.CreateModel(
            name='nom_pais',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_patana', models.CharField(blank=True, choices=[('pat_carga_seca', 'Patana de carga seca'), ('pat_carga_liquida', 'Patana de carga líquida'), ('patana_comb', 'Patana de combustible'), ('patana_ro_ro', 'Patana Ro Ro'), ('-', '-')], default='-', help_text='Escoja una opción.', max_length=30, verbose_name='Tipo de patana')),
                ('imo', models.CharField(blank=True, max_length=10, null=True, unique=True, validators=[django.core.validators.RegexValidator('^[A-Za-z]{3}[0-9]{7}$', 'Este campo comienza con 3 letras seguido de 7 dígitos.')], verbose_name='IMO')),
        ...
        migrations.AddField(
            model_name='nom_entidades',
            name='provincia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nomencladores.nom_provincia'),
        ),
        migrations.CreateModel(
            name='nom_puerto',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_equipo_especifico', models.CharField(blank=True, max_length=45, null=True, verbose_name='Tipo de equipo específico')),
