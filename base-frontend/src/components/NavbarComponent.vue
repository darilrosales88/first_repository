<template>
  ...
  />
    ...
    <ul class="navbar-nav">
      <div class="home">
        <router-link to="/home"><i class="bi bi-houses-fill home-icon"></i></router-link>
      </div>
      <!-- Enlaces del menú -->
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-dark scrollable-menu" aria-labelledby="navbarDropdownNomencladores">
          ...
          <li><hr class="dropdown-divider"></li>
          <li><router-link class="dropdown-item" to="/Producto">Productos</router-link></li>
          <li><hr class="dropdown-divider"></li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-dark w-100 scrollable-menu" aria-labelledby="navbarDropdown">
          <li><a class="dropdown-item" style="width: 200px;" href="#">GEMAR</a></li>
          <li><hr class="dropdown-divider"></li>
          ...
          <li><hr class="dropdown-divider"></li>
          <li><router-link class="dropdown-item" to="/ufc">UFC</router-link></li>
          <li><hr class="dropdown-divider"></li>
