...
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (16,'Asada',34,43,43,34,'remolcador','-','-','-',347,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (17,'Qwrt',7,57,76,6,'buque','buque_granelero','-','QWE1234567',NULL,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (19,'Aaaaaa',0.03,0.03,0.03,0.03,'remolcador',NULL,NULL,NULL,987,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (20,'Asadert',12,12,12,12,'otros',NULL,NULL,NULL,NULL,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (21,'Asadeeww',43,43,34,34,'buque','buque_frig',NULL,'ASD1234567',NULL,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (22,'Gasfdf',546,7587,67,678,'remolcador',NULL,NULL,NULL,890,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (23,'Cgdhfgh',5,45,45,456,'buque','buque_granelero',NULL,'ASD1234569',NULL,1);
INSERT INTO "nomencladores_nom_embarcacion" ("id","nombre_embarcacion","eslora","manga","calado_maximo","desplazamiento_maximo","tipo_embarcacion","tipo_buque","tipo_patana","imo","potencia","nacionalidad_id") VALUES (24,'Asdfsdfg',346,456,456,45,'remolcador',NULL,NULL,NULL,339.9,1);
...
INSERT INTO "nomencladores_nom_puerto" ("id","nombre_puerto","latitud","longitud","pais_id","provincia_id","servicio_portuario_id") VALUES (4,'Puerto Escondido Dos','345','4674',1,1,1);
...
INSERT INTO "nomencladores_nom_terminal" ("id","nombre_terminal","capacidad_almacen_importacion","capacidad_almacen_exportacion","puerto_id") VALUES (2,'Terminal Uno',224.65,331.76,3);
INSERT INTO "nomencladores_nom_terminal" ("id","nombre_terminal","capacidad_almacen_importacion","capacidad_almacen_exportacion","puerto_id") VALUES (3,'Terminal Dos',224.65,331.76,1);
...
INSERT INTO "nomencladores_nom_entidades" ("id","nombre","abreviatura","codigo_reeup","tipo_entidad","osde_oace_organismo_id","provincia_id","territorio_id") VALUES (1,'Cuba Ron SA','CRSA','23455','importador',1,1,2);
INSERT INTO "nomencladores_nom_entidades" ("id","nombre","abreviatura","codigo_reeup","tipo_entidad","osde_oace_organismo_id","provincia_id","territorio_id") VALUES (6,'Acceso comercial uno','ACuno','1212121','acceso_comercial',1,1,2);
INSERT INTO "nomencladores_nom_entidades" ("id","nombre","abreviatura","codigo_reeup","tipo_entidad","osde_oace_organismo_id","provincia_id","territorio_id") VALUES (7,'CCD Uno','CCDU','1212121245','ccd',1,1,2);
...
INSERT INTO "nomencladores_nom_tipo_equipo_ferroviario" ("id","tipo_equipo","tipo_carga","tipo_combustible","longitud","peso_neto_sin_carga","peso_maximo_con_carga","capacidad_cubica_maxima","descripcion") VALUES (4,'cist_liquidos','combustible','combustible_blanco',12333,111,11233,123144,'La turbo');
...
INSERT INTO "nomencladores_nom_tipo_maniobra_portuaria" ("id","nombre_maniobra","tipo_maniobra") VALUES (2,'Maniobra de salida otra','salida');
...
INSERT INTO "nomencladores_nom_atraque" ("id","nombre_atraque","puerto_id","terminal_id") VALUES (6,'Mjaaa',3,3);
INSERT INTO "nomencladores_nom_atraque" ("id","nombre_atraque","puerto_id","terminal_id") VALUES (7,'DLAD',1,1);
INSERT INTO "nomencladores_nom_atraque" ("id","nombre_atraque","puerto_id","terminal_id") VALUES (8,'ADAD',1,3);
INSERT INTO "nomencladores_nom_atraque" ("id","nombre_atraque","puerto_id","terminal_id") VALUES (9,'AQWE',1,1);
INSERT INTO "nomencladores_nom_atraque" ("id","nombre_atraque","puerto_id","terminal_id") VALUES (10,'QDAS',1,3);
...
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (2,'LOCO0073','oriente','Combustible','Combustible negro',11233,'Disponible',4);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (4,'LOCOMB001','oriente','Combustible','Combustible negro',2,'Disponible',3);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (11,'AAAAFFFF','centro','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (12,'ADqq11','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (15,'ARRQQQ','centro','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (16,'AQWE','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (17,'HASFF','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (18,'HAV1','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (19,'HAV2','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (20,'HAV3','occidente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (21,'STG1','oriente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (22,'STG2','oriente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (23,'STG3','oriente','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (24,'CAV1','centro','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (25,'CAV2','centro','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (26,'CAV3','centro','Contenedores','Combustible blanco',1234,'Disponible',6);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (27,'VCL1','centro','Otros','-',12444,'Disponible',8);
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","estado_actual","tipo_equipo_id") VALUES (28,'VCL2','centro','Contenedor','Combustible blanco',1234,'Disponible',8);
