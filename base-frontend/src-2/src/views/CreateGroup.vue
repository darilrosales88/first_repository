  ...
  <div class="form-container">
    ...
    <form @submit.prevent="saveItem">
      ...
      <div class="form-buttons">
        <button type="button"><router-link style="color:white;text-decoration:none" to="/groups">Cancelar</router-link> </button>
...
export default {
  ...
  methods: {
    validateForm() {
      ...
      if (!nombre_regex.test(this.name)) {
        valid = false;
    ...
    async saveItem() {
      ...
      try {
        ...
        console.log(error);
        Swal.fire('Error', 'Hubo un error al agregar el grupo.', 'error');
      } finally {
