<template>
    ...
    <div class="container mt-2 px-6" style="padding-left: 10%">
      <div class="row mb-4">
        <h2 class="mb-4">Editar registro de situados</h2>
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="text-center">
            ...
            <button @click="confirmCancel" class="btn btn-secondary" :disabled="loading">
              Cancelar
            </button>
          </div>
        </form>
      ...
      async cargarRegistro() {
        ...
        try {
          ...
          this.formData = {
            ...
            pendiente_proximo_dia: registro.pendiente_proximo_dia,
