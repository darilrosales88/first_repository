        ...
        <div class="card border">
            ...
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-center">
                    <router-link v-if="hasGroup(['AdminUFC', 'OperadorUFC']) && this.habilitado" to="/AnnadirPorSituarCCD">
...
export default {
  ...
  methods: {
    ...
    async getElements() {
      try {
        ...
        if (this.informeID || infoID.data.id) {
            this.loading = true;
            const response = await axios.get("/ufc/ccd-por-situar/", {
                params: {
    ...
    async delete_element(id) {
      try {
        await axios.delete(`/ufc/ccd-por-situar/${id}/`);
