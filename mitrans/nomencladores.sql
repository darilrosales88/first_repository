...
INSERT INTO "nomencladores_nom_tipo_equipo_ferroviario" ("id","tipo_equipo","tipo_carga","tipo_combustible","longitud","peso_neto_sin_carga","peso_maximo_con_carga","capacidad_cubica_maxima","descripcion") VALUES (1,'planc_plat','miel','combustible_blanco',4674,423,23423,546,'Una descrip');
INSERT INTO "nomencladores_nom_tipo_equipo_ferroviario" ("id","tipo_equipo","tipo_carga","tipo_combustible","longitud","peso_neto_sin_carga","peso_maximo_con_carga","capacidad_cubica_maxima","descripcion") VALUES (2,'planc_plat','contenedores','combustible_blanco',3423,4234,234,4234,'Para contenedores');
...
INSERT INTO "nomencladores_nom_tipo_equipo_ferroviario" ("id","tipo_equipo","tipo_carga","tipo_combustible","longitud","peso_neto_sin_carga","peso_maximo_con_carga","capacidad_cubica_maxima","descripcion") VALUES (6,'planc_plat','combustible','combustible_turbo',456,1254,345345,213123,'La Loqui');
...
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","tipo_equipo_id","estado_actual") VALUES (1,'VFD5400','centro','Miel','Combustible blanco',23423,1,'Asignado al estado Cargado/Descargado');
...
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","tipo_equipo_id","estado_actual") VALUES (3,'PPC5509','centro','Contenedores','Combustible blanco',234,2,'Asignado al estado Cargado/Descargado');
...
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","tipo_equipo_id","estado_actual") VALUES (5,'PPM5401','centro','Miel','combustible_blanco',23423,1,'Asignado al estado Cargado/Descargado');
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","tipo_equipo_id","estado_actual") VALUES (6,'PPC5508','occidente','Contenedores','combustible_blanco',234,2,'Asignado al estado Cargado/Descargado');
INSERT INTO "nomencladores_nom_equipo_ferroviario" ("id","numero_identificacion","territorio","tipo_carga","tipo_combustible","peso_maximo","tipo_equipo_id","estado_actual") VALUES (7,'PP5510','occidente','Contenedores','combustible_blanco',234,2,'Asignado al estado Cargado/Descargado');
