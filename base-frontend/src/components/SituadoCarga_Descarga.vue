        ...
        <tbody>
          ...
          <tr v-for="(item, index) in registrosPorSituar" :key="item.id">
            ...
            <td style="display:flex">
              <button class="btn btn-sm btn-info me-1" @click="showDetails(item)" title="Ver detalles">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="detail-item">
                ...
                <span class="detail-value">{{ selectedItem.tipo_origen || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Origen:</span>
                <span class="detail-value">{{ selectedItem.origen || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Tipo de equipo:</span>
                <span class="detail-value">{{ selectedItem.tipo_equipo || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Estado:</span>
                <span class="detail-value">{{ selectedItem.estado || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Operación:</span>
                <span class="detail-value">{{ selectedItem.operacion || 'N/A' }}</span>
              </div>
            </div>
            <div class="col-md-6 mb-3">
              <div class="detail-item">
                <span class="detail-label">Producto:</span>
                <span class="detail-value">{{ selectedItem.producto_name || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Situados:</span>
                <span class="detail-value">{{ selectedItem.situados || '0' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Pendientes por situar:</span>
                <span class="detail-value">{{ selectedItem.pendiente_proximo_dia || '0' }}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Observaciones:</span>
                <span class="detail-value">{{ selectedItem.observaciones || 'Ninguna' }}</span>
              </div>
