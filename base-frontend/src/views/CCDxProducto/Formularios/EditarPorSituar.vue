    ...
    <div class="card border">  
      <div class="card-header bg-light border-bottom">
        <h5 class="mb-0 text-dark fw-semibold">
          <i class="bi bi-file-earmark-plus me-2"></i> Editar registro vagón por situar
        </h5>
      </div>
...
export default {
  ...
  methods: {
    ...
    async get_registro() {
      try {
        const response = await axios.get(`/ufc/ccd-por-situar/${this.registroId}/`);
        ...
        this.formData.causas_incumplimiento = registro.causas_incumplimiento
    ...
    async submitForm() {
      try {
        ...
        const response = await axios.patch(`/ufc/ccd-por-situar/${this.registroId}/`, payload);
        this.resetForm();
        this.$router.push({ name: "ccdxproducto" });
