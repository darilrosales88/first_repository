    ...
    <div class="card border">  
      <div class="card-header bg-light border-bottom">
        <h5 class="mb-0 text-dark fw-semibold">
          <i class="bi bi-file-earmark-plus me-2"></i> Casilla Centro de Carga/Descarga
        </h5>
      </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label class="form-label small fw-semibold text-secondary">Entro Hoy</label>
  ...
  methods: {
    ...
    async submitForm() {
      try {
        ...
        const response = await axios.post("/ufc/ccd-por-situar/", payload);
        this.resetForm();
        this.$router.push({ name: "ccdxproducto" });
