# Generated by Django 5.1.2 on 2025-04-20 04:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('por_situar', models.CharField(max_length=10, verbose_name='Por situar')),
                ...
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producto_por_situar', to='ufc.producto_en_vagon', verbose_name='Producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='productos_vagones_productos',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_producto', models.CharField(choices=[('producto', 'Producto'), ('contenedor', 'Contenedor')], max_length=20)),
                ('cantidad', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, help_text='Ingrese observaciones adicionales. Admite letras, números y caracteres especiales.', null=True, verbose_name='Observaciones')),
                ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ufc.producto_en_vagon')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ManyToManyField(blank=True, related_name='vagones_asociados', to='ufc.productos_vagones_cargados_descargados')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ManyToManyField(blank=True, related_name='producto_vagones_productos', to='ufc.productos_vagones_productos')),
