    ...
    <div class="container py-3" style="margin-left: 17.3em; width: 75%">
      <div class="card border">
        <div class="card-header bg-light border-bottom">
          <h6 class="mb-0 text-dark fw-semibold">Listado de destinos</h6>
        </div>
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <router-link
              ...
              to="/AdicionarDestino"
            >
              <i class="bi bi-plus-circle me-1"></i>Adicionar destino
            </router-link>
            <form @submit.prevent="searchDestinos" class="search-container">
  ...
  methods: {
    ...
    async getDestinos() {
      try {
        ...
        this.destinos = response.data.results; // Obtener los registros de la página actual
    ...
    async deleteDestino(id) {
      try {
        ...
        this.destinosFiltrados = this.destinosFiltrados.filter(
    ...
    openatraqueDetailsModal(destino) {
      Swal.fire({
