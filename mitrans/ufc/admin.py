...
from .models import registro_vagones_cargados,por_situar,registro_vagones_cargados,vagones_productos,productos_vagones_productos
...
admin.site.register(productos_vagones_productos)
