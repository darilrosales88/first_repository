# Generated by Django 5.1.2 on 2025-04-24 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ManyToManyField(blank=True, related_name='productos_por_situar', to='ufc.producto_en_vagon', verbose_name='Productos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, help_text='Ingrese observaciones adicionales. Admite letras, números y caracteres especiales.', null=True, verbose_name='Observaciones')),
                ('producto', models.ManyToManyField(blank=True, related_name='productos_situados', to='ufc.producto_en_vagon', verbose_name='Productos')),
            ],
        ),
        migrations.CreateModel(
