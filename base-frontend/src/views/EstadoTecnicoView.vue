      ...
      <div class="card border">
        ...
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <router-link v-if="hasGroup('Admin')" to="AdicionarEstadoTecnico">
              <button class="btn btn-sm btn-primary">
                <i class="bi bi-plus-circle me-1"></i>Adicionar estado técnico
              </button>
            </router-link>
            <form @submit.prevent="search_estado_tecnico" class="search-container">
                ...
                <tr v-for="item in estados_tecnicos" :key="item.id">
                  ...
                  <td>
                    <div class="d-flex" style="margin-left: 30%;">
                      ...
                      <router-link
                        :to="{ name: 'EditarEstadoTecnico', params: { id: item.codigo_estado_tecnico } }"
                        v-if="hasGroup('Admin')"
...
import EditarEstadoTecnico from "./EditarEstadoTecnico.vue";
